...
<body>
    <div class="container">
        ...
        <main class="content">
            <div class="block">
                <h2><?= $id ? 'Modifier' : 'Écrire' ?> un article</h2>
                <form action="/FormArticle.php<?= $id ? "?id=$id" : "" ?>" , method="POST">
                    ...
                    <div class="form-control">
                        ...
                        <select name="category" id="category">
                            <option <?= $category || $category === 'technology' ? 'selected' : '' ?> value="technology">Technologies</option>
                            <option <?= $category || $category === 'nature' ? 'selected' : '' ?> value="nature">Nature</option>
                            <option <?= $category || $category === 'travel' ? 'selected' : '' ?> value="travel">Voyage</option>
                        </select>
                    ...
                    <div class="form-action">
                        ...
                        <button class="btn-save" type="submit"><?= $id ? "Modifier" : "Sauvegarder" ?></button>
                    </div>
                </form>
            </div>
